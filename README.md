...
* As some courses' materials change over the years, we can't (and won't) guarantee that our badges are (and will be) 100% accurate (for eternity). Those badges are but our estimations. 
