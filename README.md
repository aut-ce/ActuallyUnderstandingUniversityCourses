...
This repository is a list of publicly available materials for actually understanding the courses being taught at Iranian universities, the English ones being mostly in the form of video lectures made publicly availble on YouTube by universities such as [Stanford](https://www.youtube.com/user/StanfordUniversity), [MIT](https://www.youtube.com/user/MIT), and so on. The Persian courses are mostly due to Sharif University of Technology's decision to make its courses available on platforms such as [Sharif's OpenCourseWare](http://ocw.sharif.edu/) and [MaktabKhooneh](https://maktabkhooneh.org/).
